...
const CandidateList = () => {
    ...
    const currentCandidates = candidateData.slice(indexOfFirstItem, indexOfLastItem);
        ...
        <div className="p-6">
            <div className="flex justify-between items-center mb-4">
                ...
                <button className="border px-4 py-2 rounded text-sm flex items-center space-x-2">
                    <span><IoIosMenu className='mt-1' /></span>
                    <span>Filter</span>
                </button>
            </div>
                ...
                <tbody>
                    {currentCandidates.map((candidate, index) => (
                        <tr key={candidate.id} className="border-b hover:bg-gray-50">
                            ...
                            <td className="p-2">{candidate.twelfth}%</td>
                            <td className="p-2 text-center">{candidate.graduation}%</td>
            ...
            <div className="flex justify-between items-center mt-4">
                <p className="text-sm text-gray-600">
                    Showing {indexOfFirstItem + 1}-{Math.min(indexOfLastItem, candidateData.length)} of {candidateData.length}
                </p>
