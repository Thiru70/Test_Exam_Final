...
const Sidebar = () => {
  ...
  const menu = [
    ...
    { path: "/database", label: "Resultdatabaseaccount", icon: "mdi:database" },
    { path: "/studentForm", label: "StudentForm", icon: "mdi:form-select" },
    { path: "/MyAccount", label: "MyAccount", icon: "mdi:account-circle-outline" },
